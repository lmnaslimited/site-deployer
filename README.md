...
-  **Linux/macOS/Windows**: The scripts are designed for Unix-like systems
...
SITES=example.com # Domain(s) for the site (comma-separated)
...
- Check that the API key is correctly set in C
